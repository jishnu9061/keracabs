...
class WebBlogController extends Controller
{
    ...
    public function index()
    {
        ...
        $blogs = Blog::select('id', 'title', 'image', 'description', 'created_at', 'slug', 'keyword', 'blog_details','image_alt')->limit(8)->get();
    ...
    public function blogDetailPage(Request $request, $slug)
    {
        ...
        $recentPosts = Blog::select('id', 'title', 'image', 'description', 'created_at', 'slug', 'keyword', 'blog_details','seo_title','image_alt')->latest()->limit(4)->get();
