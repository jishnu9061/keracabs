...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Student Fee</h4>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form id="stages-form" method="POST" action="{{ route('student.store') }}">
                    @csrf
                    <div class="table-responsive mb-0" data-pattern="priority-columns">
                        <table class="table table-editable table-bordered table-nowrap align-middle table-edits">
                            <tbody id="stages-table-body">
                                @if($studentFee && $studentFee->price_data)
                                    @php
                                        $stages = json_decode($studentFee->price_data, true);
                                    @endphp
